          ...
          <header className='flex flex-col items-center text-center'>
            ...
            <div className='mt-5 space-y-2'>
              <div className='flex flex-wrap items-center justify-center gap-2'>
                ...
                <Badge variant='secondary'>
                  <CheckCheck /> Verification
                </Badge>
              </div>
              <h1 className='text-5xl font-bold shadow-heading tracking-tight sm:text-6xl'>
                {siteConfig.name}
              </h1>
              <div className='mx-auto pt-2 max-w-prose whitespace-nowrap text-sm text-muted-foreground sm:text-base'>
                {siteConfig.description}
                <br />
                Use code <pre className='inline'>V2S_Z6ZXGB</pre> to join
                'Public' organization
              </div>
            </div>
          </header>
